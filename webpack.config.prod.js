...
export default {
  ...
  module: {
    rules: [
      ...
      {test: /\.[ot]tf(\?v=\d+.\d+.\d+)?$/, loader: 'url-loader?limit=10000&mimetype=application/octet-stream&name=fonts/[name].[ext]'},
      ...
      {test: /\.css$/, loader: ExtractTextPlugin.extract('css-loader?modules=1&localIdentName=[hash:base64:4]&sourceMap!postcss-loader')}
    ]
  }
};
